		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#vaishnaviapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vaishnaviapp1-display": {
								"semanticObject": "vaishnaviapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vaishnaviapp1",
									"url": sap.ui.require.toUrl("vaishnaviapp1")
								}
							}
						}
					}
